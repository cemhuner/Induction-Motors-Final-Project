...
#define AI_NETWORK_MODEL_SIGNATURE     "0xbb4761ec733fcff10957033ef8add484"
...
#define AI_TOOLS_DATE_TIME   "2026-02-10T23:54:28+0300"
...
AI_ARRAY_OBJ_DECLARE(
  ts_input_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#3 */
AI_ARRAY_OBJ_DECLARE(
  fft_input_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
  concatenate_output_array, AI_ARRAY_FORMAT_FLOAT,
...
AI_TENSOR_OBJ_DECLARE(
  concatenate_output, AI_STATIC,
  0, 0x0,
  AI_SHAPE_INIT(4, 1, 1312, 1, 1), AI_STRIDE_INIT(4, 4, 4, 5248, 5248),
  1, &concatenate_output_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 40), AI_STRIDE_INIT(4, 4, 4, 128, 128),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x0,
  AI_SHAPE_INIT(4, 1312, 32, 1, 1), AI_STRIDE_INIT(4, 4, 5248, 167936, 167936),
...
/* Tensor #24 */
AI_TENSOR_OBJ_DECLARE(
  fft_input_output, AI_STATIC,
  24, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 160), AI_STRIDE_INIT(4, 4, 4, 4, 4),
  1, &fft_input_output_array, NULL)

/* Tensor #25 */
AI_TENSOR_OBJ_DECLARE(
  ts_input_output, AI_STATIC,
  25, 0x0,
  AI_SHAPE_INIT(4, 1, 400, 1, 1), AI_STRIDE_INIT(4, 4, 4, 1600, 1600),
  1, &ts_input_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &concatenate_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_1_dense_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  concatenate_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 2, &conv1d_1_conv2d_output0, &dense_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &concatenate_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_LAYER_OBJ_DECLARE(
  ...
  NULL, &concatenate_layer, AI_STATIC, 
  .groups = 1, 
  .nl_params = NULL, 
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &fft_input_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv1d_conv2d_output),
...
AI_LAYER_OBJ_DECLARE(
  ...
  nl, forward_relu,
  &dense_chain,
  NULL, &conv1d_conv2d_layer, AI_STATIC, 
  .nl_params = NULL, 
)

AI_TENSOR_CHAIN_OBJ_DECLARE(
  dense_dense_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &ts_input_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_dense_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 226712, 1, 1),
    226712, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 10816, 1, 1),
    10816, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &fft_input_output, &ts_input_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_2_output),
  &dense_dense_layer, 0x42740df1, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    fft_input_output_array.data = AI_PTR(g_network_activations_map[0] + 5696);
    fft_input_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5696);
    ts_input_output_array.data = AI_PTR(g_network_activations_map[0] + 4096);
    ts_input_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4096);
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 6336);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6336);
    dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5568);
    dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5568);
    conv1d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 6336);
    conv1d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 6336);
    conv1d_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 6348);
    conv1d_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 6348);
    conv1d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 448);
    conv1d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 448);
    conv1d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 256);
    conv1d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
    conv1d_1_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_1_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    conv1d_1_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 5696);
    conv1d_1_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5696);
    concatenate_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    concatenate_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    dense_1_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 5248);
    dense_1_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5248);
    ...
    dense_2_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    dense_2_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 51200);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 51200);
    conv1d_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 51328);
    conv1d_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 51328);
    conv1d_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 51520);
    conv1d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 51520);
    conv1d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 51584);
    conv1d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 51584);
    conv1d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 57728);
    conv1d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 57728);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 57856);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 57856);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 225792);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 225792);
    dense_2_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 225920);
    dense_2_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 225920);
    dense_2_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 226688);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 226688);
    return true;
  }
