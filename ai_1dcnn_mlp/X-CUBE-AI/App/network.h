...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "stm32_hybrid_cnn_mlp"
...
#define AI_NETWORK_IN_1_SIZE        (160)
#define AI_NETWORK_IN_1_SIZE_BYTES  (640)
#define AI_NETWORK_IN_2_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_IN_2_CHANNEL     (400)
#define AI_NETWORK_IN_2_SIZE        (400)
#define AI_NETWORK_IN_2_SIZE_BYTES  (1600)
